    ...
    <div class="flex flex-wrap container mx-auto justify-center mt-4py-3 px-3 shadow-lg rounded bg-gray-200">
        <div class="w-full my-3 py-1 px-2 md:px-4 justify-between flex bg-white rounded shadow-sm">
            ...
            <div class="justify-between content-center items-center md:justify-end flex flex-wrap w-full md:w-auto">
                <span v-if="submitted" class="self-center flex flex-wrap flex-row text-right text-primary text-sm my-1 ml-2 py-1 px-2 font-semibold rounded border border-solid border-primary">
                ...
                <span v-if="submitted" @click="delete_name" class="self-center cursor-pointer flex flex-wrap flex-row text-right text-primary hover:text-black bg-primary hover:bg-primary-800 text-sm my-1 ml-2 py-1 px-2 font-semibold rounded border border-solid border-primary">
