<template>
    <div class="flex flex-wrap container mx-auto justify-center mt-4py-3 px-3 shadow-lg rounded bg-gray-200">
        <div class="w-full my-3 py-1 px-4 justify-between flex bg-white rounded shadow-sm">
            <div class="flex">
                <span class="text-gray-600 text-sm my-1 ml-2 py-1 px-2 font-semibold">Build with : </span>
